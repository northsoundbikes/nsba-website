...
<header class="bg-blue-200">
    ...
    {#if mobileMenuOpen}
        <div class="lg:hidden" role="dialog" aria-modal="true">
            ...
            <div
                class="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-blue-200 p-4 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10"
            >
        ...
        <p class="text-sm leading-5 text-white text-center">
            <a href="#events">
                <strong class="font-semibold ss-04"
                    >🔔 July & August events and Advocacy announced</strong
                ><svg
                    viewBox="0 0 2 2"
